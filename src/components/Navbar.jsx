...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center  justify-between py-5 mx-8 sm:mx-20 md:mx-24 lg:mx-32 xl:mx-40'>
      ...
      <button onClick={() => navigate('/admin')} className='flex items-center text-1.5xl font-bold rounded-full cursor-pointer bg-orange-500 text-white hover:bg-orange-600-transition px-6 py-2'>
