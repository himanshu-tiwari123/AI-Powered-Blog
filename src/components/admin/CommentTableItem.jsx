...
export const CommentTableItem = () => {
    ...
    const  {blog,cretedAt,_id } = comment;
    const BlogDate = new Date(cretedAt);
    ...
    <tr className='border-y border-gray-300'>
      ...
      <td className='px-6 py-4'>
         <div className='inline-flex items-center gap-4'>
          {
          !commet.isApproved ? <img src={assets.tick_icon} className='w-5 hover:scale-110 transition-all cursor-pointer'></img> :
